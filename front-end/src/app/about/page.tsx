          ...
          <div className="text-center">
            ...
            <div className="max-w-5xl mx-auto mb-12">
              <p className="text-2xl md:text-3xl font-light leading-relaxed mb-6">
                ...
                <strong className="font-bold text-blue-200">
                  F-Gas certification training center
                </strong>
                , dedicated to excellence in{" "}
                <strong className="font-bold text-blue-200">
                  {" "}
                  Refrigeration and HVAC education
                </strong>
              </p>
              <p className="text-xl leading-relaxed opacity-95">
                For over 15 years, we&apos;ve been shaping the careers of{" "}
                <strong className="font-semibold">
                  refrigeration and air conditioning professionals{" "}
                </strong>
                across the capital, providing comprehensive, practical{" "}
                <strong className="font-semibold">F-Gas training</strong> that
                empowers technicians to work safely, legally, and confidently
                with{" "}
                <strong className="font-semibold">
            ...
            <div className="flex flex-wrap justify-center gap-8 mb-12">
              <div className="bg-white/20 backdrop-blur-sm px-8 py-6 rounded-2xl border border-white/30 hover:bg-white/30 transition-all duration-300 transform hover:scale-105">
                <div className="text-4xl font-black text-blue-200">900+</div>
                <div className="text-lg font-medium">Students Trained</div>
              </div>
              <div className="bg-white/20 backdrop-blur-sm px-8 py-6 rounded-2xl border border-white/30 hover:bg-white/30 transition-all duration-300 transform hover:scale-105">
                <div className="text-4xl font-black text-blue-200">90%</div>
          ...
          <div className="mb-16">
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-12 md:p-16 border-t-4 border-[#156BAA] hover:shadow-3xl transition-shadow duration-500">
              <p className="text-2xl md:text-3xl text-gray-800 leading-relaxed font-light">
                ...
                <strong className="font-bold text-[#156BAA]">
                ...
                through innovative, practical training that sets the gold
              ...
              <p className="text-xl text-gray-700 leading-relaxed">
                ...
                <strong className="font-semibold text-gray-900">
                  Refrigeration and HVAC professional
                </strong>{" "}
                has access to world-class education that not only meets{" "}
                <strong className="font-semibold text-gray-900">
                  regulatory requirements
                </strong>{" "}
                but exceeds industry expectations, delivered by experienced
                instructors with decades of practical expertise in the field.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="mb-16">
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl p-12 md:p-16 border border-white/20">
              <p className="text-2xl md:text-3xl text-white leading-relaxed mb-12 font-light">
                To provide comprehensive, practical, and accredited{" "}
                ...
                <strong className="font-bold text-blue-300">
                  {" "}
                  Refrigeration and HVAC professionals
                </strong>{" "}
                to work safely, legally, and confidently with
                <strong className="font-bold text-blue-300">
                  {" "}
                  fluorinated greenhouse gases
                </strong>{" "}
                while contributing to environmental sustainability and industry
                excellence.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
                  ...
                  <p className="text-lg text-gray-200 leading-relaxed">
                    ...
                    <strong className="font-semibold text-white">
                      F-Gas certification training
                    </strong>{" "}
                    with practical, hands-on learning experiences using
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
                  ...
                  <p className="text-lg text-gray-200 leading-relaxed">
                    ...
                    <strong className="font-semibold text-white">
                      professional Refrigeration and HVAC training{" "}
                    </strong>
                    and{" "}
                    <strong className="font-semibold text-white">
                      F-Gas certification excellence
                    </strong>{" "}
                    in London&apos;s refrigeration and air conditioning sector
                  </p>
                </div>
                <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:scale-105">
                  <h3 className="text-2xl font-bold text-blue-300 mb-4">
                  ...
                  <p className="text-lg text-gray-200 leading-relaxed">
                    ...
                    and advanced skills that accelerate their careers in the{" "}
                    <strong className="font-semibold text-white">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-gray-900 mb-8">
              Why Choose Hope BTC for Your{" "}
              <span className="text-[#156BAA]">F-Gas Training</span>?
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 text-center hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-t-4 border-green-500">
              ...
              <p className="text-gray-700">
                Industry professionals with 50+ years{" "}
                <strong> Refrigeration HVAC experience</strong>
              </p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 text-center hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-t-4 border-purple-500">
              ...
              <p className="text-gray-700">
                Proven track record in <strong>F-Gas certification</strong>{" "}
                success
              </p>
            </div>
          </div>
      ...
      <section className="py-24 px-4 bg-gradient-to-r from-[#156BAA] via-[#1e7bc4] to-[#2a87d4] text-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <h2 className="text-5xl md:text-6xl font-black mb-8">
            Ready to Start Your{" "}
            <span className="text-blue-300">F-Gas Journey</span>?
          </h2>
          <p className="text-2xl mb-12 leading-relaxed font-light">
            Join the Hope BTC family and become part of London{" "}
            <strong className="font-bold text-blue-300">
              F-Gas training community
            </strong>
            . Our expert instructors and comprehensive{" "}
            <strong className="font-bold text-blue-300">
              {" "}
              Refrigeration and HVAC courses
            </strong>{" "}
            will set you up for career success.
          </p>
          ...
          <div className="bg-white/15 backdrop-blur-lg rounded-3xl p-12 border border-white/30">
            <p className="text-xl mb-6 font-medium">
              Questions about our <strong>F-Gas certification training</strong>?
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8 gap-x-16 text-center">
              <div>
                <a
                  href="tel:+447359609398"
                  className="text-3xl font-black mb-2 text-blue-300 inline-block hover:underline"
                >
                  07359 609398{" "}
                </a>
              ...
              <div>
                ...
                <a
                  ...
                  className="text-lg opacity-90 hover:underline inline-block"
                >
                  info@hopebtc.co.uk
                </a>
              </div>
